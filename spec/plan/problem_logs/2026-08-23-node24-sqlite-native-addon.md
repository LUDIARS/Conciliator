...
Upgrading the runtime to Node.js 24 exposed a regression in the SQLite native addon dependency. Conciliator still selected a pre-Node-24 major of `better-sqlite3`.
...
No tests were run in this session by policy. The registered test suite now opens and closes an in-memory database; Revisor should install dependencies and run the suite under Node 24.
